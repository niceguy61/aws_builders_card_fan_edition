...
export const RULEBOOK_SECTIONS: { title: string; body: string[] }[] = [
  {
    title: '🎯 목표',
    body: [
  ...
  },
  {
    title: '🔄 턴 순서 (공식 순서)',
    body: [
      '① 폐기: 턴 시작·시작핸드 5장 한정. 핸드 빌더(AWS) > 온프렘이면(3vs2·4vs1) 핸드에서 온프렘 1장 영구 제거. 제거했으면 이번 턴 도입 ≥1 필수.',
  ...
  return (
    <div className="overlay" onClick={onClose}>
      <div className="panel rules-panel" onClick={(e) => e.stopPropagation()}>
        <h2>📖 핵심 룰 요약 <span className="ed">공식 룰북 기반</span></h2>
